...
const topdf = async (msg, sender) => {
    try {
        ...
        let media;
        let extension;
        let fileNameWithoutExtension = 'topdf';
        ...
        if(msg.hasMedia && msg.type == 'document' || msg.type == 'image') {
            ...
            if(reply.hasMedia && reply.type == 'document' || reply.type == 'image') {
        ...
        const callback = function (error, data, response) {
            if (error) {
                ...
                const path = `./database/${ fileNameWithoutExtension }.pdf`
