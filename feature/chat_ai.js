    ...
    if(prompt == "reset"){
        ...
        try {
            ...
            if(err.includes('timeout')) {
                ...
                if(errinfo == "invalid_api_key") return 'Saldo APIKEY sharing dari admin telah habis, cobalah untuk menggunakan Private APIKEY anda dengan mengirim pesan */updateAPI [PasteApikeyHere]*. Ikuti link dibawah cara mendapatkan APIKEY ChatGPT :\nhttps://youtu.be/R3yF02N1Oq4?si=2yCeBYOm5lxYV2tu\n\n==================================\n\nThe APIKEY sharing balance from the admin has run out, try to use your Private APIKEY by sending the message */updateAPI [PasteApikeyHere]*. Follow the link below to get APIKEY ChatGPT:\nhttps://youtu.be/R3yF02N1Oq4?si=2yCeBYOm5lxYV2tu';
